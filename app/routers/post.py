...
def get_orm_posts(
    ...
    ## SQL syntax used for results with additional filtering
    # select post.*,COUNT(vote.post_id) AS "votes"
    # from post
    # left join vote
    ...
    # results = db.query(func.count(models.Vote.post_id).label("total_votes")).all()
